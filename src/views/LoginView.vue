  ...
  <div class="flex min-h-screen items-center justify-center bg-[#f1f5f9] font-sans relative overflow-hidden">
    ...
    <div class="z-10 w-full max-w-md bg-white p-10 rounded-[32px] shadow-2xl shadow-blue-100 border border-gray-50">
     ...
     <form @submit.prevent="handleLogin" class="space-y-5">
        <div>
          <label class="block text-[10px] font-black text-gray-400 uppercase mb-2 ml-1 tracking-widest">E-mail</label>
          <div class="relative">
        ...
        <div>
          <label class="block text-[10px] font-black text-gray-400 uppercase mb-2 ml-1 tracking-widest">Senha</label>
          <div class="relative">
        ...
        <div class="flex items-center justify-between px-1">
          <a href="#" class="text-[10px] font-bold text-blue-600 uppercase hover:underline">Esqueci a senha</a>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      mostrarSenha: false, // Adicionada esta variável para controlar a visão
      carregando: false
    }
  },
  methods: {
